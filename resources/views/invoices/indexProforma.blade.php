        ...
        <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            ...
            <div>
                <div class="btn-wrapper">
                    <form id="filterForm" method="GET" action="{{ route('invoice.indexProforma') }}">
                        <div class="row mb-3">
                            <div class="col-md-6">
                            <input 
                                type="text" 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="documentOptionsForm" action="{{ route('generate.proformainvoices.multiple') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="generateInvoice">Generate Customer Invoice</label>
                        </div>
                        {{-- <div class="form-check">
...
$(document).ready(function() {
    ...
    function fetchInvoices() {
        ...
        $.ajax({
            url: "{{ route('invoices.ajaxSearchProforma') }}",
            method: 'GET',
