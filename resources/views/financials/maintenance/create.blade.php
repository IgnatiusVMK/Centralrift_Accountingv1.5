              ...
              <div class="card">
                <div class="card-body">
                  <div class="card-header">
                    ...
                    @endif
                  <h4 class="card-title">New Maintenance Records
                    ...
                    <div class="mb-3">
                      ...
                      @error('maker_id') <span class="text-danger">{{ $message}}</span> @enderror
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="Fin_Id_Id" class="form-control" value="{{ $maintuniqueCode }}" readonly/>
                          @error('Fin_Id_Id') <span class="text-danger">{{ $message}}</span> @enderror
                        </div>
                        <div class="mb-3">
                          <label>Type</label>
                          <input type="text" name="type" class="form-control" value="maintenance" readonly/>
