            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{ route('capital-expenses.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3">
                      ...
                      @error('maker_id') <span class="text-danger">{{ $message}}</span> @enderror
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="Fin_Id_Id" class="form-control" value="{{ $cpexpeuniqueCode}}" readonly/>
                          @error('Fin_Id_Id') <span class="text-danger">{{ $message}}</span> @enderror
                        </div>
                        <div class="mb-3">
                          <label>Type</label>
                          <input type="text" name="type" class="form-control" value="Capital Expenses" readonly/>
